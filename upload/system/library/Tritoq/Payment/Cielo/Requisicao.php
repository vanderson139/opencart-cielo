...
class Requisicao
{
    ...
    public function send($ssl = false)
    {
        ...
        if ($this->status != 400) {
            ...
            if(!$this->xmlRetorno) {
                $this->xmlRetorno = new \SimpleXMLElement('<erro xmlns="http://ecommerce.cbmp.com.br" id=""><codigo>001</codigo><mensagem><![CDATA[O XML informado não é válido]]></mensagem></erro>');
            }
